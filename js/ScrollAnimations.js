        ...
        setup: function (items) {
            ...
            if ($children.length) {
                ...
                $children.each(function () {
                    var $child = $(this);
                    var $delay = $child.attr('data-delay');
                    var $duration = $child.attr('data-duration');
                    var $easing = $child.attr('data-easing');
                    $child.css({
                        ...
                        '-webkit-transition-timing-function': $easing + 's',
                        '-moz-transition-timing-function': $easing + 's',
                        '-ms-transition-timing-function': $easing + 's',
                        '-o-transition-timing-function': $easing + 's',
                        'transition-timing-function': $easing + 's',
                    });
                });
